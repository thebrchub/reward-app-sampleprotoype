...
const mockNotifications = [
  {
    ...
    message: 'Transfer 50K points to KrisFlyer (Singapore Airlines) for a 20% bonus until Friday.',
    time: '2m ago',
    unread: true,
    icon: Sparkles,
  ...
  },
  {
    ...
    message: 'Your IndieByll invoice for ₹3,45,000 has cleared and is available in your account.',
    time: '1h ago',
    unread: true,
    icon: ArrowDownLeft,
  ...
  },
  {
    ...
    message: 'Your upcoming flight to DXB is eligible for a business class upgrade using 25K points.',
    time: 'Yesterday',
    unread: false,
    icon: Plane,
